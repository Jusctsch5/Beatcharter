...
def main():
    ...
    parser.add_argument("-e", "--argparse",            help="type of encoding to perform (e.g., sm, ssc, beatmania")
    parser.add_argument("-d", "--default", type=float, default=0.0, help="optional duration to generate steps for in the song. default - whole duration")
